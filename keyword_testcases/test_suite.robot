...
TC00005_Diary_Add Quicknote - Adding a quicknote
    [Documentation]    Adding a quick note to a booking. Quick Note is saved with image, text, and PDF; printed copy includes all details.
    ...
    Add Image To Quick Note    ${add.quicknote.imageButton}    ${QUICK_NOTE_DATA.file.image_path}
    # Step 10: Add text to Quick Note
    Add Text To Quick Note    ${add.quicknote.textArea}    ${QUICK_NOTE_DATA.input.quick_note_text}
    # Step 11-12: Upload PDF to Quick Note
    Upload PDF To Quick Note    ${add.quicknote.pdfButton}    ${QUICK_NOTE_DATA.file.pdf_path}
    # Step 13: Print Quick Note
    Print Quick Note    ${print.quicknote.button}
