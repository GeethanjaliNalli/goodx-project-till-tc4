...
TC00005_Diary_Add Quicknote - Adding a quicknote
    [Documentation]    Adding a quick note to a booking. Quick Note is saved in the Patient’s Clinical record.
    ...
    Add Image To Quick Note    ${quicknote.imageUploadButton}    ${quicknote.imageFileInput}    ${quicknote.imagePreview}
    ...
    Upload PDF To Quick Note    ${quicknote.pdfUploadButton}    ${quicknote.pdfFileInput}    ${quicknote.pdfPreview}
