...
TC00005_Diary_Add Quicknote - Adding a quicknote
    ...
    Select Quick Note Form    ${quicknote_form_locator}
    # Step 5-9: Add image to Quick Note
    Add Image To Quick Note    ${quicknote_image_upload_locator}    ${QUICK_NOTE_DATA.image_path}
    # Step 10: Add text to Quick Note
    Add Text To Quick Note    ${quicknote_textarea_locator}    ${QUICK_NOTE_DATA.note_text}
    # Step 11-12: Upload PDF to Quick Note
    Upload PDF To Quick Note    ${quicknote_pdf_upload_locator}    ${QUICK_NOTE_DATA.pdf_path}
    # Step 13: Print Quick Note
    Print Quick Note    ${quicknote_print_button_locator}
