...
TC00005_Diary_Add Quicknote - Adding a quicknote
    ...
    Open Diary And Open Clinical Sidebar For Booking    ${DIARY_MODULE}    ${BOOKING_INFO}[input.time]
    # Step 3-4: Select Quick Note Form
    Select Quick Note Form    ${quick_note_form_button}
    # Step 5-9: Add image to Quick Note
    Add Image To Quick Note    ${quick_note_add_image_button}    ${QUICK_NOTE_DATA.input.select_image}
    # Step 10: Add text to Quick Note
    Add Text To Quick Note    ${quick_note_textbox}    ${QUICK_NOTE_DATA.textbox.note_text}
    # Step 11-12: Upload PDF to Quick Note
    Upload PDF To Quick Note    ${quick_note_add_pdf_button}    ${QUICK_NOTE_DATA.input.select_pdf}
