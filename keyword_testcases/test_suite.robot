...
TC00005_Diary_Add Quicknote - Adding a quicknote
    ...
    Add Image To Quick Note    ${QUICK_NOTE_DATA}[UPLOAD_IMAGE_FILE_INPUT]
    # Step 10: Add text to Quick Note
    Add Text To Quick Note    ${QUICK_NOTE_DATA}[QUICK_NOTE_TEXTAREA]
    # Step 11-12: Upload PDF to Quick Note
    Upload PDF To Quick Note    ${QUICK_NOTE_DATA}[UPLOAD_PDF_FILE_INPUT]
