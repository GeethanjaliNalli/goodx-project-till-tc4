...
TC00005_Diary_Add Quicknote - Adding a quicknote
    ...
    # Step 1-2: Navigate to Diary and open Clinical Sidebar
    Open Diary And Open Clinical Sidebar
    # Step 3-4: Select Quick Note form in Clinical Sidebar
    Select Quick Note Form In Clinical Sidebar
    # Step 5-9: Add image to Quick Note
    Add Image To Quick Note    ${QUICK_NOTE_DATA.image_file}
    # Step 10: Add text to Quick Note
    Add Text To Quick Note    ${QUICK_NOTE_DATA.quick_note_text}
    # Step 11-12: Upload PDF to Quick Note
    Upload PDF To Quick Note    ${QUICK_NOTE_DATA.pdf_file}
