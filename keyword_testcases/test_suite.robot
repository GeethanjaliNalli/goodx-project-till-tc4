...
TC00005_Diary_Add Quicknote - Adding a quicknote
    ...
    Add Image To Quick Note    ${quicknote.addImageButton}    ${quicknote.imageUploadInput}
    # Step 10: Add text to Quick Note
    Add Quick Note Text    ${quicknote.textArea}    ${QUICK_NOTE_INFO.input.quick_note_text}
    # Step 11-12: Upload PDF to Quick Note
    Upload PDF To Quick Note    ${quicknote.addPdfButton}    ${quicknote.pdfUploadInput}
