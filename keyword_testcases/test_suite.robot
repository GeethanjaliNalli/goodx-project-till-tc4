...
TC00005_Diary_Add Quicknote - Adding a quicknote
    ...
    Open Diary And Open Clinical Sidebar    ${DIARY_MODULE}    ${QUICK_NOTE_DATA.button.clinical}
    # Step 3-4: Select Quick Note form from forms library
    Select Quick Note Form    ${QUICK_NOTE_DATA.dropdown.forms.library}
    # Step 5-9: Add image to Quick Note
    Add Image To Quick Note    ${QUICK_NOTE_DATA.button.add.image}
    # Step 10: Add text to Quick Note
    Add Text To Quick Note    ${QUICK_NOTE_DATA.input.quicknote.text}
    # Step 11-12: Upload PDF to Quick Note
    Upload PDF To Quick Note    ${QUICK_NOTE_DATA.button.upload.from.file}
    # Step 13: Print Quick Note
    Print Quick Note    ${QUICK_NOTE_DATA.button.print}
