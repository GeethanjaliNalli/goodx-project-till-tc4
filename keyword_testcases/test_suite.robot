...
TC00005_Diary_Add Quicknote - Adding a quicknote
    [Documentation]    Adding a quick note to a booking. Quick Note is saved in the Patient’s Clinical record. Email and Print logs are recorded in the Patient communication history.
    ...
    Add Image To Quick Note    ${quicknote.imageUpload}
    # Step 10: Add text to Quick Note
    Add Quick Note Text    ${QUICK_NOTE_INFO}[textarea.quick_note_text]
    # Step 11-12: Upload PDF to Quick Note
    Upload PDF To Quick Note    ${quicknote.pdfUpload}
    # Step 13: Print Quick Note
    Print Quick Note    ${QUICK_NOTE_INFO}[button.print_quick_note]
