...
TC00005_Diary_Add Quicknote - Adding a quicknote
    ...
    Add Image To Quick Note    ${quicknote.imageUpload}    ${QUICK_NOTE_DATA.file.image_path}
    # Step 10: Add text to Quick Note
    Add Quick Note Text    ${quicknote.textarea}    ${QUICK_NOTE_DATA.input.quick_note_text}
    # Step 11-12: Upload PDF to Quick Note
    Upload PDF To Quick Note    ${quicknote.pdfUpload}    ${QUICK_NOTE_DATA.file.pdf_path}
